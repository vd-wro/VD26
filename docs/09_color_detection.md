...
| **Sensor Utilization** | Uses both the **front-facing (`sonarFront`)** and **side-facing (`sonarRight`, `sonarLeft`) ultrasonic sensors** to guide turn initiation and and execution. | 
